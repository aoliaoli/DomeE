...
- (void)showTipsView
{
    ...
    switch(_enState)
    {
        ...
        case STATE_WIFI:
        {
            ...
            self.wifiLabel.text = NSLocalizedString(@"已配置好Wi-Fi网络", nil);
            ...
            self.registerLabel.text = NSLocalizedString(@"快了快了,正在注册平台服务器", nil);
            self.bindLabel.text = NSLocalizedString(@"绑定你的账号", nil);
        ...
        case STATE_LINE:      //有线连接添加逻辑
        {
            ...
            self.bindLabel.text = NSLocalizedString(@"绑到你的账号下就大功告成了哦", nil);
        ...
        case STATE_PLAT:
        {
            ...
            self.wifiLabel.text = NSLocalizedString(@"已配置好Wi-Fi网络", nil);
            self.registerLabel.text = NSLocalizedString(@"已注册到萤石平台", nil);
            //计算文字的长度
